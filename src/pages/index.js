...
export default function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>Tushar Singh - Software Engineer Portfolio</title>
        <meta
          name="description"
          content="Results-driven Software Engineer with expertise in building scalable web applications. Currently pursuing MS in Software Engineering at San Jose State University."
        />
        <meta
          name="keywords"
          content="Tushar Singh, Software Engineer, Full Stack Developer, React, Java, Spring Boot, Portfolio"
        />
      </Head>
