...
export default function EducationPage() {
  return (
    <>
      <Head>
        <title>Education | Tushar Singh</title>
        <meta
          name="description"
          content="Educational background of Tushar Singh - MS in Software Engineering from San Jose State University and BTech from NIT Manipur."
        />
      </Head>
